...
namespace DzialaniaPodstawowe
{
    internal class Dzialania
    {
        ...
        {
            Console.Write("Podaj liczbę jaka ma zostać zaokrąglona. Liczba powinna być z wartością po przecinku: ");
            double number = Pobierz.LiczbeDouble();
            Console.WriteLine("Liczba po zaokrągleniu do całości to: " + Math.Round(number));
        }
